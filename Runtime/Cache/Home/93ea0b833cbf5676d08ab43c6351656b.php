...
<html lang="zh-cn">
  ...
  <div class="main-full">
    <div class="page-header">
      <h3>新闻公告 <small>News Bulletin</small></h3>
    </div>
    <div class="row">
          ...
          <div class="panel-body">
            <div class="news-head">
              <ul class="nav nav-tabs">
                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><li role="presentation" <?php if(($menu['active']) == "1"): ?>class="active"<?php endif; ?>><a href="<?php echo (U($menu['url'])); ?>"><?php echo ($menu["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
            </div>
            <div class="news-main">
              ...
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><div class="news">
                  <div class="news-body">  
                    <p class="news-title"><a href="<?php echo U('index/document',array('id'=>$list['id']));?>" title="Lavish Post-Modern, Past Retro, Vintage and Hipster Styles in Website Design"><?php echo ($list["title"]); ?></a></p>
                    <div class="news-summary"> 
                      <span class="news-category"><a><?php echo (get_menu($list["menu_id"])); ?></a></span> 
                      <span class="news-excerpt"><p><?php echo ($list["description"]); ?>...</p>
                      </span>
                      <div class="news-meta">
                        <span class="news-author"><a href="#" rel="author"><?php echo ($list["username"]); ?></a></span> ·
                        <span class="news-date"><?php echo (time_format($list["update_time"])); ?></span>
                      </div>
                    </div>
                  </div>
