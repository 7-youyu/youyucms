...
<html lang="zh-cn">
  ...
  <div class="main-full">
    <div class="page-header">
      <h3>学习资源 <small>Learning Resources</small></h3>
    </div>
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-9">
        <div class="panel panel-default">
          <div class="panel-body">
            <h5><span class="glyphicon glyphicon-education" aria-hidden="true"></span> &nbsp;&nbsp;全部</h5><hr>
            <div class="row">
              <?php if(is_array($list)): foreach($list as $key=>$list): ?><div class="col-sm-6 col-md-4">
                  <div class="thumbnail">
                    <img src="/my_project/lab_manage/youyulabmanage/3<?php echo (get_cover($list["cover_id"])); ?>" data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
                    <div class="caption">
                      <h3><?php echo ($list["title"]); ?></h3>
                      <p><?php echo ($list["description"]); ?></p>
                      <p><a href="<?php echo U('index/document',array('id'=>$list['id']));?>" class="btn btn-primary" role="button">进入学习</a></p>
                    </div>
                  </div>
