...
<html lang="zh-cn">
  ...
  <div class="main-full">
    <div class="page-header">
      <h3>历届成员 <small>Previous Members</small></h3>
    </div>
    <div class="number">
      <div class="number-head"><h5>成员排名不分先后</h5></div>
      <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><div class="number-main">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;<?php echo ($menu["name"]); ?></h3>
            </div>
            <div class="panel-body">
              <div class="row">
                <?php if(is_array($menu["child"])): $i = 0; $__LIST__ = $menu["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i;?><div class="col-lg-2">
                    <img class="img-circle" src="/my_project/lab_manage/youyulabmanage/3<?php echo (get_cover($child["cover_id"])); ?>" alt="Generic placeholder image">
                    <h2><a href="<?php echo ((isset($child["show_url"]) && ($child["show_url"] !== ""))?($child["show_url"]):'#'); ?>" target="_block"><?php echo ($child["username"]); ?></a></h2>
