    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                网站 <small>首页人物</small>
                <a href="<?php echo U('Webinfo/home_people_add');?>" class="btn btn-primary">新增</a>
            </eq>
            </h1>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        <?php if(is_array($document)): foreach($document as $key=>$list): ?><tr>
                            ...
                            <td><div class="upload-img-box"><a href="/my_project/lab_manage/youyulabmanage/3<?php echo (get_cover($list["cover_id"])); ?>" target="_blank"><img src="/my_project/lab_manage/youyulabmanage/3<?php echo (get_cover($list["cover_id"])); ?>" class="img-circle" style="height:50px;width:50px"/></a></div></td>
                            ...
                            <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li role="presentation"><a href="<?php echo U('Webinfo/home_people_edit',array('id'=>$list['id']));?>"></i> 编辑</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo U('Webinfo/home_people_del',array('id'=>$list['id']));?>" onclick="winconfirm()"><i class="icon-trash"></i> 删除</a></li>
                                  </ul>
                                </div>
                            </td>
