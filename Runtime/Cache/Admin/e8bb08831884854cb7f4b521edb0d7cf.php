                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="<?php echo U('recycle/recycle_back',array('id'=>$list['id']));?>"><i class="fa fa-undo"></i> 还原</a>
                                <a class="btn btn-danger btn-xs" href="<?php echo U('recycle/recycle_del',array('id'=>$list['id']));?>" onclick="winconfirm()"><i class="fa fa-trash"></i> 彻底删除</a>
                            </td>
