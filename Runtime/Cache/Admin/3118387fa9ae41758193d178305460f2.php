    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                网站 <small>首页内容</small>
                <a href="<?php echo U('Webinfo/home_content_add');?>" class="btn btn-primary">新增</a>
            </eq>
            </h1>
                            ...
                            <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li role="presentation"><a href="<?php echo U('Webinfo/home_content_edit',array('id'=>$list['id']));?>"></i> 编辑</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo U('Webinfo/home_content_del',array('id'=>$list['id']));?>" onclick="winconfirm()"><i class="icon-trash"></i> 删除</a></li>
                                  </ul>
                                </div>
                            </td>
