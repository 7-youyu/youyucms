    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                系统 <small>菜单管理</small>
                <a href="<?php echo U('menu/menu_add');?>" class="btn btn-primary" title="add"  data-toggle="modal"  data-target="#myModal" data-target=".bs-example-modal-lg">新增</a>
            </eq>
            </h1>
                            ...
                            <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li role="presentation"><a href="<?php echo U('menu/menu_edit',array('id'=>$list['id']));?>" data-toggle="modal" data-target="#myModal"><i class="icon-pencil" data-target=".bs-example-modal-lg"></i> 编辑</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo U('menu/menu_del',array('id'=>$list['id']));?>" onclick="winconfirm()"><i class="icon-trash"></i> 删除</a></li>
                                  </ul>
                                </div>
                            </td>
