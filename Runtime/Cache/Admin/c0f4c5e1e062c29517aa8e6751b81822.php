                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
                            ...
                            <td><a href="<?php echo U('Home/Index/document',array('id'=>$list['document_id']));?>"><?php echo (get_document($list["document_id"])); ?></a></td>
                            <td><?php echo ($list["author"]); ?></td>
                            <td><?php echo (date('Y-m-d',$list["comment_date"])); ?></td>
                            <td><?php echo ($list["comment_content"]); ?></td>
                            <td>
                              <a class="btn btn-danger btn-xs" href="<?php echo U('comment/comment_del',array('id'=>$list['id']));?>" onclick="winconfirm()"><i class="fa fa-trash"></i> 删除</a>
                            </td>
